  ...
  studio: {
    ...
    process: {
      ...
      steps: [
        {
          title: "需求文档",
          content: "客户联系我们给出需求，如果没有详细的需求文档可以委托我们有偿编写（小项目无需需求文档）。",
        },
        {
          title: "预算工期",
          content: "客户给出预算和工期（也可以让我们给出，但尽量由客户自己给出，方便尽快达成合作）。",
        },
        {
          title: "可行性",
        ...
        {
          title: "UI 设计",
          content: "如果客户没有UI设计图/原型图也可以委托我们设计（小项目无需设计图，直接写代码即可）。",
        },
        {
          title: "支付定金",
          content: "开工前客户向工作室支付4成定金，随后会建立项目专属的企业微信群，项目仓库，并拉客户和开发者进来。",
        },
        {
          title: "新建仓库",
        ...
        {
          title: "CI/CD",
          content: "使用drone进行自动构建及部署到服务器（如果是移动端等则使用其它工具发版）。",
        },
        {
          title: "中期款",
        ...
        {
          title: "项目维护",
          content: "如项目交由工作室维护，则进入维护期，维护费用为：项目开发费用的20%/年（也就是项目开发总费用10w，则维护费为2w/年）。",
        },
      ],
    },
  },
