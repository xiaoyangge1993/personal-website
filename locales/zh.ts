export const zh = {
  ...
  about: {
    ...
    bio: {
      title: "关于我",
      description:
        "你好，我是养生程序员肖孝扬，远程工作者，奉行长期主义，持续学习。17 年本科毕业，干了两年 UI，因老拿着尺子和前端同事扣像素，同事吐槽你行你来，遂自学转码；目前 7 年前端开发经验，其中 2 年全栈开发，平时写点文章，研究点效率工具，也接点单子补贴家用。最近求职在看新的远程工作机会，英语口语流利，欢迎介绍机会。",
    },
    hobbies: [
      {
        title: "UI 设计",
