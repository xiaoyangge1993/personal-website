export const zh = {
  ...
  hero: {
    ...
    description:
      "我是屿风，一名热衷于打造响应式、交互性强且用户友好的 Web 应用的全栈开发者。",
    cta: "查看我的作品",
    tags: ["全栈开发", "代码洁癖", "效率至上"],
  },
  about: {
    ...
    bio: {
      title: "关于我",
      description:
        "你好，我是独立开发者屿风，远程工作者，奉行长期主义，坚持养生，持续学习。17 年本科毕业，干了两年 UI，因老拿着尺子和前端同事扣像素，同事吐槽你行你来，遂自学转码；目前 7 年前端开发经验，其中 2 年全栈开发，平时写点文章，研究点效率工具，也接点单子补贴家用。最近求职在看新的远程工作机会，英语口语流利，欢迎介绍机会。",
    },
    hobbies: [
      {
        title: "UI 设计",
  ...
  experience: {
    ...
    jobs: [
      ...
      },
      {
        ...
        role: "实习生",
        period: "2017 - 2018",
        description: "协助使用 React 和 Node.js 构建 MVP。",
      },
    ],
  },
  skills: {
  ...
  articles: {
    ...
    items: [
      ...
      {
        title: "前端生存指南：离了这十个工具，我写代码像在裸奔",
        summary:
          "作为一名在代码海洋里摸爬滚打了六年的“霞浦小码哥”，我发现程序员分两种：一种是用对工具的，一种是加班到深夜的",
        link: "https://juejin.cn/post/7601076694105079844",
      },
      {
        title: "前端工程师如何优雅入门 Node.js 并编写 API",
        summary:
          "作为一名前端工程师，你可能已经熟练掌握了 HTML、CSS 和 JavaScript，甚至对 React、Vue 这种前端框架如数家珍。",
        link: "https://juejin.cn/post/7606621855852871680",
      },
      {
        title: "Astro框架深入浅出：构建高性能内容驱动网站的新范式",
        summary:
          "今天我们来聊聊一个能让你的网站飞起来的前端框架：Astro。作为一名资深前端技术作家兼框架布道师，我的目标是让你在轻松愉快的阅读中，既能了解技术的奥秘，又能收获实战技能。",
  ...
  resources: {
    ...
    items: [
      ...
      {
        title: "Framer Motion",
        description: "React 的生产级动效库。",
        link: "https://www.framer.com/motion/",
        category: "库",
      },
      {
        title: "MDN Web 文档",
        description: "源于开发者，服务开发者的资源。",
        link: "https://developer.mozilla.org",
        category: "参考",
      },
      {
        title: "Dan Abramov",
        description: "Redux 和 Create React App 的共同作者。",
        link: "https://overreacted.io",
        category: "人物",
      },
      {
        title: "Josh W. Comeau",
        description: "关于 React 和 CSS 的互动教程。",
        link: "https://www.joshwcomeau.com",
        category: "人物",
      },
      {
        title: "Vercel",
        description: "开发、预览、发布。面向最佳前端团队。",
        link: "https://vercel.com",
        category: "平台",
      },
      {
        title: "Three.js",
        description: "JavaScript 3D 库。",
        link: "https://threejs.org",
        category: "库",
      },
      {
        title: "Dribbble",
        description: "发现全球顶尖设计师和创意专业人士。",
        link: "https://dribbble.com",
        category: "设计",
      },
      {
        title: "Awwwards",
        description: "表彰和推广最佳网页设计师的才能和努力的网站奖项。",
        link: "https://www.awwwards.com",
        category: "设计",
      },
      {
        title: "Stack Overflow",
        description: "开发者学习、分享和建立职业生涯的地方。",
  ...
  studio: {
    ...
    cooperation: {
      title: "合作说明",
      content: [
        "我们是远程团队不支持驻场等需求，一切政府和企事业项目、竞标中的项目以及二手或N手外包不接。",
        "您所开发的项目必须是符合中国法律的，我们不承接任何涉及任何灰色或黑色产业的项目（比如web3、博彩、黄色、暴力、vpn、诈骗、公网爬虫等）。",
        "工作室只提供高质量和优质的服务，不打价格战、不做低劣廉价外包以及众包，工作室目前最低承接外包价为1w元(人民币)或$1.5k(美元)。",
        "我们的外包项目是442（即先付4成订金开工、中期款再付4成、项目上线再付2成尾款）的支付方式。",
        "请先明确好您自己的项目需求（如无需求可以委托我们有偿编写需求文档，如果是小项目就没必要写详细需求了），这样更加方便我们快速与您达成合作，同时避免了后续不必要的纠纷。如果UI设计或原型图无法提供，也可以委托我们来做。",
      ],
    },
    process: {
      title: "合作流程",
      steps: [
        {
          title: "需求文档",
          content:
            "客户联系我们给出需求，如果没有详细的需求文档可以委托我们有偿编写（小项目无需需求文档）。",
        },
        {
          title: "预算工期",
          content:
            "客户给出预算和工期（也可以让我们给出，但尽量由客户自己给出，方便尽快达成合作）。",
        },
        {
          title: "可行性",
          content: "由项目经理及工作室开发人员确认可行性后即可开工。",
        },
        {
          title: "UI 设计",
          content:
            "如果客户没有UI设计图/原型图也可以委托我们设计（小项目无需设计图，直接写代码即可）。",
        },
        {
          title: "支付定金",
          content:
            "开工前客户向工作室支付4成定金，随后会建立项目专属的企业微信群，项目仓库，并拉客户和开发者进来。",
        },
        {
          title: "新建仓库",
          content: "通过私有git仓库迭代代码及处理客户工单。",
        },
        {
          title: "CI/CD",
          content:
            "使用drone进行自动构建及部署到服务器（如果是移动端等则使用其它工具发版）。",
        },
        {
          title: "中期款",
          content: "项目中期客户审核通过给出中期款。",
        },
        {
          title: "交付源码",
          content: "项目部署并交付客户源码，确认没问题后，客户支付尾款。",
        },
        {
          title: "项目维护",
          content:
            "如项目交由工作室维护，则进入维护期，维护费用为：项目开发费用的20%/年（也就是项目开发总费用10w，则维护费为2w/年）。",
        },
      ],
    },
    payment: {
      ...
      cards: [
        ...
        },
        {
          title: "关于开票",
          items: [
            "支持打对公账户开专票，但税率差需要您自己承担",
            "但是打私人账户（个体户）开普票税费比较低",
            "不过不建议10万人民币以下的项目开票",
            "合同按您自己需求确认要不要制作签署，如果开票则必须要做合同，小项目没有太大必要",
          ],
        },
        {
          title: "442 付款",
          items: [
            ...
            "项目中期再付 4 成",
            "上线或交付源码后付尾款，如项目交由工作室维护，则进入维护期，第一年免费维护，第二年维护费为：项目开发费用的20%/年",
          ],
        },
      ],
      customize_btn: "立即定制",
